...
void test(std::string test_name, std::string curve){
    ...
    // msk.Init(test.get_G1(), test.get_G2(), test.get_Zn());
    // mpk.Init(test.get_G2(), test.get_GT());
    // sks.Init(test.get_G1(), test.get_G2(), SIZE_OF_ATTR);
    // ciphertext.Init(test.get_G1(), test.get_G2(), test.get_GT(), SIZE_OF_POLICY);
    ...
    test.end("Encrypt");
    Logger::PrintPbc("ct0.ct_1", ciphertext.get_ct0()->getElement("ct_1"));
    Logger::PrintPbc("ct0.ct_2", ciphertext.get_ct0()->getElement("ct_2"));
    Logger::PrintPbc("ct0.ct_3", ciphertext.get_ct0()->getElement("ct_3"));
