 ...
 * @param As: attributes
 */
void MAPCH_ZLW_2021::SetUp(MAPCH_ZLW_2021_pp *pp, std::vector<MAPCH_ZLW_2021_mhk *> *mhks, std::vector<MAPCH_ZLW_2021_mtk *> *mtks, int k, std::vector<std::string> *As) {
...
void MAPCH_ZLW_2021::Hash(MAPCH_ZLW_2021_h *h, MAPCH_ZLW_2021_pp *pp, std::vector<MAPCH_ZLW_2021_mhk *> *mhks, std::string m, std::string policy){
    ...
    TypeConverter::mpz_to_element(tmp_GT, etd.getElement("d1"));

    etd.printElement("etd");
