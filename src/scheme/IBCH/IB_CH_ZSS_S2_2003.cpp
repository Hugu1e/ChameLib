...
void IB_CH_ZSS_S2_2003::SetUp(IB_CH_ZSS_S2_2003_msk &msk, IB_CH_ZSS_S2_2003_pp &pp, IB_CH_ZSS_S2_2003_sk &sk, IB_CH_ZSS_S2_2003_h &h, IB_CH_ZSS_S2_2003_h &h_p) {
    msk.init(1);
    pp.init(2);
    sk.init(1);
    h.get_h().init(1);
...
void IB_CH_ZSS_S2_2003::Hash(IB_CH_ZSS_S2_2003_h &h, element_t m, element_t ID, IB_CH_ZSS_S2_2003_pp &pp) {
    ...
    element_pairing(this->tmp_GT_2, pp[P], pp[P]);
...
bool IB_CH_ZSS_S2_2003::Check(IB_CH_ZSS_S2_2003_h &h, element_t m, element_t ID, IB_CH_ZSS_S2_2003_pp &pp){
    ...
    element_mul_zn(this->tmp_G_2, pp[P], this->tmp_Zn);
    element_add(this->tmp_G_2, this->tmp_G_2, pp[Ppub]);
    element_pairing(tmp_GT, tmp_G_2, h.get_r()[r1]);
...
void IB_CH_ZSS_S2_2003::Adapt(IB_CH_ZSS_S2_2003_h &h_p, element_t m_p, IB_CH_ZSS_S2_2003_h &h, element_t m, element_t ID, IB_CH_ZSS_S2_2003_sk &sk, IB_CH_ZSS_S2_2003_pp &pp) {
    ...
    element_mul_zn(this->tmp_G_2, h.get_r()[r1], this->tmp_Zn);
