...
void IB_CH_ZSS_S1_2003::SetUp(IB_CH_ZSS_S1_2003_pp &pp, IB_CH_ZSS_S1_2003_msk &msk, IB_CH_ZSS_S1_2003_pk &pk, IB_CH_ZSS_S1_2003_sk &sk, IB_CH_ZSS_S1_2003_h &h, IB_CH_ZSS_S1_2003_r &r, IB_CH_ZSS_S1_2003_r &r_p) {
    pp.init(2);
    msk.init(1);
    pk.init(1);
    sk.init(1);
...
bool IB_CH_ZSS_S1_2003::Check(IB_CH_ZSS_S1_2003_h &h, element_t m, IB_CH_ZSS_S1_2003_r &r, element_t ID, IB_CH_ZSS_S1_2003_pp &pp){
    // e(R, P)
    element_pairing(tmp_GT, r[r1], pp[P]);
