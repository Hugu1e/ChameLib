...
class MAPCH_ZLW_2021: public PbcScheme{
    ...
    public:
        ...
        void SetUp(MAPCH_ZLW_2021_pp &pp, std::vector<MAPCH_ZLW_2021_mhk *> &mhks, std::vector<MAPCH_ZLW_2021_mtk *> &mtks, int k, std::vector<std::string> &As, MAPCH_ZLW_2021_h &h, MAPCH_ZLW_2021_h &h_p);
