...
class PCH_DSS_2019: public PbcScheme{
    ...
    public:
        ...
        void SetUp(PCH_DSS_2019_pk *pkPCH, PCH_DSS_2019_sk *skPCH, int k);
        ...
        void Hash(PCH_DSS_2019_pk *pkPCH, mpz_t m, std::string policy_str, PCH_DSS_2019_h *h, PCH_DSS_2019_r *r);
