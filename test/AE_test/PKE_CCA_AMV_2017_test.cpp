...
class PKE_CCA_AMV_2017_Test : public BaseTest<TestParams>{
    protected:
        void SetUp() override {
            BaseTest::SetUp();
...
INSTANTIATE_TEST_CASE_P(
	AE_Test,
    PKE_CCA_AMV_2017_Test,
	testing::ValuesIn(test_values)
);

TEST_P(PKE_CCA_AMV_2017_Test, Test){
    PKE_CCA_AMV_2017 pke(GetParam().curve, GetParam().group);
